...
- Packaging: `debian/` for .deb, `mailroom.spec` for .rpm. The Homebrew formula lives in the `SmartLayer/homebrew-ot` tap repo at `Formula/mailroom.rb`; it points at this repo's release tarball and sha256.
